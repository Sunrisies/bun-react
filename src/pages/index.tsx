...
function Index() {
  ...
  return (
    <main className="px-6 md:px-10 lg:px-20 py-8 min-h-screen relative">
      {/* Grid background pattern - fixed to prevent jitter */}
      <div className="fixed inset-0 bg-white dark:bg-gray-950 -z-10">
        ...
        <div className="absolute inset-0 dark:opacity-100 opacity-0" style={{
          backgroundImage: `
            linear-gradient(to right, rgb(55 65 81 / 0.3) 1px, transparent 1px),
            linear-gradient(to bottom, rgb(55 65 81 / 0.3) 1px, transparent 1px)
          `,
          backgroundSize: '40px 40px'
        }}></div>
      </div>
