        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2">
              {previewUrl ? (
                <div className="border rounded-lg p-4 bg-gray-100 dark:bg-gray-900 dark:border-gray-700 h-full flex justify-center items-center">
                  <img
                    src={previewUrl}
                    alt="图片预览"
                ...
                <div className="border-2 border-dashed rounded-lg p-8 bg-gray-50 dark:bg-gray-900 dark:border-gray-700 h-full flex flex-col items-center justify-center gap-4 text-gray-400 dark:text-gray-500">
                  <svg
                    className="w-16 h-16"
                    fill="none"
                    stroke="currentColor"
              ...
              {metadata ? (
                <div className="grid grid-cols-1 gap-4 h-full">
                  <div className="space-y-2">
                    <h3 className="font-medium dark:text-gray-100">基本信息</h3>
                  ...
                  <div className="space-y-2">
                    <h3 className="font-medium dark:text-gray-100">拍摄参数</h3>
                  ...
                  {(metadata.latitude || metadata.longitude) && (
                    <div className="space-y-2">
                      <h3 className="font-medium dark:text-gray-100">位置信息</h3>
...
const MetadataItem = ({ label, value }: { label: string; value?: string }) => (
  <div className="flex justify-between items-center text-sm hover:bg-gray-50 dark:hover:bg-gray-800 rounded">
    <span className="text-muted-foreground dark:text-gray-400">{label}</span>
    <span className="font-medium dark:text-gray-200">{value || "无数据"}</span>
  </div>
)
